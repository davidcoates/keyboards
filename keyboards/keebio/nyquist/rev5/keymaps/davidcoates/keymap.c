...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_ortho_4x12(
    ...
    KC_ESCAPE,      KC_NO,          KC_NO,          KC_LEFT_ALT,    KC_LEFT_CTRL,   KC_SPACE,       OSL(_SYMBOL),   OSL(_NUMPAD),   KC_BSPC,        KC_NO,          KC_NO,          KC_ENTER
  ),

  [_SYMBOL] = LAYOUT_ortho_4x12(
    KC_EN_DASH,     KC_GRAVE,       KC_NO,          KC_PIPE,        KC_ASTR,        KC_NO,          KC_NO,          KC_BSLS,        KC_CIRC,        KC_NO,          KC_DQUO,        KC_NO,
    ...
    KC_TRNS,        KC_NO,          KC_NO,          KC_TRNS,        KC_TRNS,        KC_NO,          KC_TRNS,        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRNS
  ),
  ...
  [_ARROW] = LAYOUT_ortho_4x12(
    ...
    KC_TRNS,        KC_NO,          KC_NO,          KC_TRNS,        KC_TRNS,        KC_NO,          MO(_WINDOW),    MO(_MOUSE),     KC_NO,          KC_NO,          KC_NO,          KC_TRNS
  ),
